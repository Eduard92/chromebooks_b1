        ...
        <uib-tabset class="ui-tab">
            <uib-tab  heading="Asignacion"  ng-if="method!='details'" active="true" >
                    ...
                    <div class="form-group">
                     ...
                     <input type="hidden" class="form-control" name="org_distinct"  ng-model="form.org_distinct" >
                 ...
                 <table class="table" ng-if="historial">
                    ...
                    <tbody>
                        <tr ng-repeat="history in historial">
                            ...
                            <td>{{history.email}}</td>
                            <td>
                              <a  ng-if = "history.removido == null " target="_blank" href="acuse_f/comodato/{{history.id}}" >{{history.asignado|date :'dd/mm/yyyy'}}</a>

                              <span  ng-if = "history.removido" >{{history.asignado|date :'dd/mm/yyyy'}}</span>
                            </td>
                            <td><a target="_blank" href="acuse_f/devolucion/{{history.id}}" >{{history.removido|date :'dd/mm/yyyy'}}</a </td>
                        </tr>
                    </tbody>
                 </table>
            </uib-tab>
